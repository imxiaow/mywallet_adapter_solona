...
class Pairing extends types_1.IPairing {
    constructor(client, logger) {
        ...
        this.pending = new state_1.State(client, this.logger, this.config.status.pending);
        this.settled = new state_1.State(client, this.logger, this.config.status.settled);
