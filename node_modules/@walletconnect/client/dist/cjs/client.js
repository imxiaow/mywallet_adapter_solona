...
class Client extends types_1.IClient {
    constructor(opts) {
        ...
        this.name = constants_1.CLIENT_CONTEXT;
        ...
        const keyValueStorage = (opts === null || opts === void 0 ? void 0 : opts.storage) || new keyvaluestorage_1.default(Object.assign(Object.assign({}, constants_1.CLIENT_STORAGE_OPTIONS), opts === null || opts === void 0 ? void 0 : opts.storageOptions));
        this.crypto = new crypto_1.Crypto(this, this.logger, opts === null || opts === void 0 ? void 0 : opts.keychain);
        this.relayer = new controllers_1.Relayer(this, this.logger, opts === null || opts === void 0 ? void 0 : opts.relayProvider);
        this.storage = new storage_1.Storage(this, this.logger, keyValueStorage);
    ...
    setBeatInterval() {
        setInterval(() => this.events.emit(constants_1.CLIENT_EVENTS.beat), utils_1.toMiliseconds(constants_1.CLIENT_BEAT_INTERVAL));
    }
